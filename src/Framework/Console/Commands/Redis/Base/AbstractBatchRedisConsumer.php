 ...
 *
 * Base class for Redis consumers that process messages in batches.
 * Provides high-throughput processing with configurable batch size and interval.
 *
 * Performance Benefits:
 * - Reduced processing overhead per message
 * - Better throughput (10k+ messages/sec)
 * - Atomic batch processing
 * - Lower memory overhead
 *
 * Architecture:
 * - Redis Pub/Sub is push-based (event-driven)
 ...
 * Usage:
 * ```php
 * class MyBatchConsumer extends AbstractBatchRedisConsumer
 * {
